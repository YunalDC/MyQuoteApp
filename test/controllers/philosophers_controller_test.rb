...
class PhilosophersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create philosopher" do
    assert_difference("Philosopher.count") do
      post philosophers_url, params: { philosopher: { b_year: @philosopher.b_year, bio: @philosopher.bio, d_year: @philosopher.d_year, fname: @philosopher.fname, lname: @philosopher.lname } }
    end
  ...
  test "should update philosopher" do
    patch philosopher_url(@philosopher), params: { philosopher: { b_year: @philosopher.b_year, bio: @philosopher.bio, d_year: @philosopher.d_year, fname: @philosopher.fname, lname: @philosopher.lname } }
